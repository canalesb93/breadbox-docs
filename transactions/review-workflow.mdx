...
Agents summarize each session via the [reports API](/api/reports) (or the [`submit_report` MCP tool](/mcp/reference/reports)). For an end-to-end walkthrough, see the [Single Routine Reviewer guide](/guides/single-routine-reviewer). To connect an AI agent to your Breadbox instance, see the [MCP overview](/mcp/overview).
