...
If your household has multiple family members, add them from **Settings → Users** before linking additional banks so each connection can be attributed to the right person.
