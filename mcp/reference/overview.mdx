...
- Transactions: [`query_transactions`, `count_transactions`, `transaction_summary`, `merchant_summary`, `list_transaction_matches`, `list_annotations`](/mcp/reference/transactions) — plus the deprecated [`list_transaction_comments`](/mcp/reference/transactions#list_transaction_comments) (use `list_annotations` with `kinds=['comment']` instead).
