...
<CardGroup cols={3}>
  ...
  <Card title="CSV import" icon="file-csv" href="/connections/csv-import">
    Works for any institution, with no API credentials. Useful for banks Plaid and Teller don't cover, historical data, and migrations from other tools. <Badge color="blue" icon="hammer" iconType="solid">BETA</Badge>
  </Card>
</CardGroup>
