---
title: "Get started with Breadbox"
description: "Connect a bank, sync your first transactions, and query them through the REST API — from a fresh install to your first API response in minutes."
---
