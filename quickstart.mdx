...
Onboarding picks up where [installation](/installation) leaves off. By the end of this guide, you'll have completed the first-run setup wizard, linked a bank account, watched the initial sync complete, and attached an AI agent over <Tooltip tip="Model Context Protocol — modelcontextprotocol.io">[MCP](https://modelcontextprotocol.io)</Tooltip>.
