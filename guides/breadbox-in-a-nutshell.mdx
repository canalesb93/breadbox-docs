...
3. **Manually overridden** — you (or an agent) set the category by hand. Manual overrides set `category_override = true`, which _protects the transaction from rules_ going forward.
