...
Field presets are documented per resource in the [API Reference](/api-reference). Passing `--fields` keeps responses small over slow links and reduces the JSON your agent has to parse.
